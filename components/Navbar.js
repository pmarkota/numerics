          ...
          >
            ...
            >
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-lg blur opacity-20 group-hover:opacity-40 transition-opacity"></div>
                <div className="relative bg-gradient-to-r from-emerald-600 to-teal-600 p-2 rounded-lg">
                  <Calculator className="h-6 w-6 text-white" />
                </div>
              </div>
              <span className="text-2xl font-bold bg-gradient-to-r from-emerald-900 to-teal-800 bg-clip-text text-transparent">
                Numerics
              </span>
            </button>
          </motion.div>
            ...
            <div className="flex items-center space-x-1">
              {navItems.map((item, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg scale-0 group-hover:scale-100 transition-transform duration-200"></div>
                  <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-emerald-600 to-teal-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-200"></div>
                </motion.button>
              ))}
                ...
                <button
                  ...
                  className={`flex items-center space-x-1 px-4 py-2 text-sm font-medium rounded-lg transition-all ${
                    language === 'hr' 
                      ...
                      : 'bg-gray-100 text-gray-600 hover:text-emerald-900'
                  }`}
                >
